...
namespace LanternCardGame.Data.Migrations
{
    ...
    [Migration("20210822135848_AddPlayersStatsGamesStartedColumn")]
    partial class AddPlayersStatsGamesStartedColumn
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LanternCardGame.Data.PlayerStats", b =>
                {
                    ...
                    b.Property<int>("GamesPlacedLast")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LanternCardGame.Data.UserFriend", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("LanternCardGame.Data.UserFriend", b =>
                {
                    b.HasOne("LanternCardGame.Data.ApplicationUser", "FriendUser")
                        .WithMany()
                        .HasForeignKey("FriendUserId");

                    b.HasOne("LanternCardGame.Data.ApplicationUser", "User")
                        .WithMany("Friends")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("LanternCardGame.Data.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
